...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	e8 fb fe ff ff       	call   2ca <write>
  while(--i >= 0)
 ...
 3fe:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 433:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 436:	e8 8f fe ff ff       	call   2ca <write>
 ...
 4a6:	e8 1f fe ff ff       	call   2ca <write>
        putc(fd, c);
 ...
 4c0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 4c3:	e8 02 fe ff ff       	call   2ca <write>
  for(i = 0; fmt[i]; i++){
 ...
 550:	e8 75 fd ff ff       	call   2ca <write>
        while(*s != 0){
 ...
 580:	e8 45 fd ff ff       	call   2ca <write>
 ...
 5d0:	e8 f5 fc ff ff       	call   2ca <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6da:	e8 53 fc ff ff       	call   332 <sbrk>
  if(p == (char*)-1)
