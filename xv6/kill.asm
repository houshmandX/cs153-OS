...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	e8 fb fe ff ff       	call   2ba <write>
  while(--i >= 0)
 ...
 3ee:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 423:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 426:	e8 8f fe ff ff       	call   2ba <write>
 ...
 496:	e8 1f fe ff ff       	call   2ba <write>
        putc(fd, c);
 ...
 4b0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 4b3:	e8 02 fe ff ff       	call   2ba <write>
  for(i = 0; fmt[i]; i++){
 ...
 540:	e8 75 fd ff ff       	call   2ba <write>
        while(*s != 0){
 ...
 570:	e8 45 fd ff ff       	call   2ba <write>
 ...
 5c0:	e8 f5 fc ff ff       	call   2ba <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6ca:	e8 53 fc ff ff       	call   322 <sbrk>
  if(p == (char*)-1)
